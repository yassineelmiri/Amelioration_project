	...
	<div id="wrapper">
		...
		<header id="header">
			...
			<div class="content">
				<div class="inner">
					<h1>Distributeur</h1>
					<p>A fully  site  de la gestion de bank<br />
						for free under the <a href="../login/index.php">return page home</a> license.</p>
				</div>
			</div>
			<nav>
				<ul>
		...
		<div id="main">
			...
			<article id="intro">
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis dapibus rutrum facilisis. Class aptent
					...
					Pellentesque aliquam maximus risus, vel sed vehicula >>>>>>><a href="st_login.php">   Distributeur</a>.</p>
			</article>
