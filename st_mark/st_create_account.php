...
if (!isset($_FILES['image']['tmp_name'])) {
   ...
   if ($picture == "") {
      echo "<script>alert('Choisissez une image')</script>";
   } else {
      if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg") {
         echo "<script>alert('Type de fichier non pris en charge. Utilisez PNG, JPG ou JPEG.')</script>";
      } else {
   ...
   <center>
      ...
      <div class="container">
         <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group col-lg-12 col-sm-8">
               <label for="Author" class="col-sm-2 control-label">Numéro de téléphone</label>
               <div class="col-sm-10">
                  <input type="number" class="form-control" maxlength="9" name="phone" placeholder="Numéro de téléphone"
                     required>
               </div>
            </div>
            ...
            <div class="form-group col-lg-12 col-sm-8">
               ...
               <div class="col-sm-10">
                  <input type="file" class="form-control" name="image" placeholder="Image" value="<?php echo ''; ?>"
                     required>
               </div>
            </div>
