...
if (!isset($_FILES['image']['tmp_name'])) {
	...
	if ($picture == "") {
		...
		if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg") {
			echo "<script>alert('Les formats PNG, JPG et JPEG sont autorisés !')</script>";
		} else {
				...
				<div class="container">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="form-group col-lg-12 col-sm-8">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="username" placeholder="Nom d'utilisateur"
									value="<?php echo $upusername; ?>" required>
							</div>
						</div>
						...
						<div class="form-group col-lg-12 col-sm-8">
							...
							<div class="col-sm-10">
								<input type="password" class="form-control" name="password" placeholder="Mot de passe"
									value="<?php echo $uppassword; ?>" required>
							</div>
						</div>
						...
						<div class="form-group col-lg-12 col-sm-8">
							...
							<div class="col-sm-10">
								<input type="file" class="form-control" name="image" id="image" p
