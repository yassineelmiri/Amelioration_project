		...
		<div class="col-md-10 mx-auto">
			...
			<div class="card">
				<div class="card-body bg-dark text-white">
					...
					<a href="<?php echo BASE_URL; ?>logout" title="Déconnexion" class="btn btn-link mr-2 mb-2 text-white">
					...
					<table class="table table-hover">
						<thead>
							<tr>
								<th scope="col" class="text-white">Nom & Prénom</th>
								<th scope="col" class="text-white">RIB</th>
								<th scope="col" class="text-white">Département</th>
								<th scope="col" class="text-white">Poste</th>
								<th scope="col" class="text-white">Date Embauche</th>
